...
public class MainPageObject {
  ...
  public void assertElementPresent(String error_message, By by) {
    Assert.assertNotNull(error_message, driver.findElements(by).size());
  }
  ...
  public void swipeElementToLeft(String locator, String error_message) {
    WebElement element = waitForElementPresent(
            locator,
            "Cannot find element by swiping left. \n" + error_message,
            0);
